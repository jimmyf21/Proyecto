...
public class SucursalTableModel extends AbstractTableModel implements javax.swing.table.TableModel {
    List<Sucursal> rows;
    int[] cols;

    public SucursalTableModel(int[] cols, List<Sucursal> rows){
        initColNames();
        this.cols=cols;
        this.rows=rows;
    }
